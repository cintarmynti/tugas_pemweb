                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">TAMBAHKAN WISATA</h1>
                        ...
                        <form action="code.php" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-md-6 mt-3">
                                    <label for="">HTM</label>
                                    <input type="text" name="htm" class="form-control" id="">
                                </div>
                                ...
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-primary" name="tambah_wisata_btn">Save</button>
                                </div>
