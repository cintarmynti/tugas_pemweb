    ...
    ?>
            <div class="body">
                ...
                <div class="text-left">
                    ...
                    <p><?= $data['desc']; ?></p>
                    <p class="sub-judul">Informasi Penginapan</p>
                    <div class="sub-menu">
                        <img class="icon" src="../../assets/icons/location.png" alt="">
                        <p><span class="text-span">Alamat: </span><?= $data['alamat']; ?></p>
                    </div>
                    <div class="sub-menu">
                        <img class="icon" src="../../assets/icons/tv.png" alt="">
                        <p><span class="text-span">Fasilitas: </span><?= $data['fasilitas']; ?></p>
                    </div>
                    <div class="sub-menu">
                        <img class="icon" src="../../assets/icons/Iconly-Call-1717902496947.svg" alt="">
                        <p><span class="text-span">Kontak: </span><?= $data['kontak']; ?></p>
                    </div>
                </div>
            </div>
    <?php
